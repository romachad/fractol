...
/*   Updated: 2022/11/02 04:41:41 by romachad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	message(void)
{
	ft_printf("Invalid option(s)! Please use the arguments as shown below:\n\
		...
		3- A value for the Imaginary number (e.g.: 0.54) --Valid only for Julia Fractol\n");
	ft_printf("WARNING: Using set julia without providing arguments 2 and 3 they will be assumed as zero.\n");
	ft_printf("\nBelow are some examples for the Julia set:\n");
	ft_printf("./fractol j 0 0.8\n./fractol j 0.355534 -0.337292\n./fractol j 0.3125 0.566176471\n");
}
